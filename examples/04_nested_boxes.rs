//! Example 4: Nested Rectes
//!
//! Demonstrates:
//! - Creating hierarchical widget structures
//! - Nesting rectes inside rectes
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("=== Example 4: Nested Rectes ===\n");
    ...
    println!("4.1 Two-Level Nesting:");
    {
        ...
        let label = label_new!(20).add_text("In Child Rect")?;
        child_rect.add_child(label, (5, 3))?;

        root.add_child(child_rect, (20, 10))?;

        println!("  Root Rect: 80×30");
        println!("  ├─ Child Rect: 40×15 at (20, 10)");
    ...
    println!("4.2 Three-Level Nesting:");
    {
        ...
        let mut level1 = rect_new!(60, 25);
        let mut level2 = rect_new!(40, 20);
    ...
    println!("4.3 Multiple Children Per Level:");
    {
        ...
        // First branch
        let mut branch1 = rect_new!(35, 25);
        ...
        // Second branch
        let mut branch2 = rect_new!(35, 25);
    ...
    {
        let mut level0 = rect_new!(80, 30);
        let mut level1 = rect_new!(70, 25);
        let mut level2 = rect_new!(60, 20);
        let mut level3 = rect_new!(50, 15);
        let mut level4 = rect_new!(40, 10);
    ...
    println!("\n=== Nested Rectes Example Complete ===");
    Ok(())
}
