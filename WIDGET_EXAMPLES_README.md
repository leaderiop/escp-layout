...
### 03. Rect Container (`03_rect_container.rs`)
...
**Run**: `cargo run --example 03_rect_container`

### 04. Nested Rectes (`04_nested_rectes.rs`)
...
**Run**: `cargo run --example 04_nested_rectes`
...
- How Stack returns overlapping rectes at (0, 0)
...
**Important**: Stack rectes cannot be added to the same parent (causes overlap).
...
- Understand basic widgets (Label, Rect)
